...
<c:set value="${productAttr}" var="p"></c:set>
<form action="<c:url value='/cart/addtocart'></c:url>">
<tr><td><font color="white">ENTER QUANTITY</font></td><td><input type="number" name="requestedQuantity" min="1" max="${productAttr.quantity} "></td></tr>
